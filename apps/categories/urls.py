...
urlpatterns = [
    ...
    path("customers/<int:pk>/edit/", CustomerCategoryUpdateView.as_view(), name="customers_edit"),
    ...
    path("products/<int:pk>/edit/", ProductCategoryUpdateView.as_view(), name="products_edit"),
