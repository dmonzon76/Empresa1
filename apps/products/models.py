...
class Product(models.Model):
    ...
    quantity_type = models.CharField(
        max_length=10, choices=UNIT_CHOICES, default='unit', verbose_name='Quantity type'
    )
    quantity_value = models.DecimalField(
        max_digits=10, decimal_places=2, default=1, verbose_name='Quantity value'
    )

    color = models.CharField(
        max_length=20, choices=COLOR_CHOICES, blank=True, null=True, verbose_name='Color'
    )
